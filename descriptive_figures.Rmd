...
p4 <- ggplot(filtered_patients_by_pair, aes(x=medication_procedure, y=n, fill=adverse_effect)) +
  geom_bar(stat="identity") +
...
p5 <- ggplot(filtered_patients_by_severity, aes(x=severity_score, y=n, fill=adverse_effect)) +
  geom_bar(stat="identity") +
